...
object ScoreStorage {
    ...
    fun loadAll(context: Context): MutableList<ScoreEntry> {
        ...
        val type = object : com.google.gson.reflect.TypeToken<MutableList<ScoreEntry>>() {}.type
    ...
    fun loadTop10(context: Context): List<ScoreEntry> {
        return loadAll(context).sortedByDescending { it.score }.take(10)
    }
}
